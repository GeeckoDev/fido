...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public static class SendFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            btn_contact.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent contactInfo = new Intent(Intent.ACTION_PICK, Contacts.CONTENT_URI);
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            if (requestCode == REQUEST_CODE_CONTACT_NUMBER && resultCode == RESULT_OK) {
        ...
        private CharSequence[] getContactNumbers(long contactId) {
            ...
            final Cursor cursor = activity.getContentResolver().query(Data.CONTENT_URI,
            ...
            for (int i = 0; i < count; i++) {
                ...
                entries[i] = CommonDataKinds.Phone.getTypeLabel(getResources(), type, label) + ": " + data;
            }
